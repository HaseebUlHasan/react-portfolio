...
export const metadata: Metadata = {
  title: 'Haseeb Ul Hasan | Portfolio',
  description:
    'Check out modern and stylish porfolio of an experienced Web Developer Haseeb Ul Hasan! Built using TypeScript, Next.js 14, Framaer Motion and Tailwind CSS.',
};
